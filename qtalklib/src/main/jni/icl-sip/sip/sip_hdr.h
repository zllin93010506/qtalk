 ...
 * sip_hdr.h
 *
 * $Id: sip_hdr.h,v 1.5 2009/02/06 07:45:11 tyhuang Exp $
 */
...
/* Header Refer-Sub */
typedef	struct sipReferSub_t SipReferSub;
struct sipReferSub_t{
	BOOL	value;
	SipParam*	paramList;
};
...
/* Header Record-Route */
typedef struct sipRoute_t		SipRecordRoute;
...
/* Header Min-SE*/
typedef struct sipSessionExpires_t SipMinSE;

/* Header Session-Expires */
typedef struct sipSessionExpires_t{
	int		deltasecond;
	SipParam*	paramList;
}SipSessionExpires;
...
/* Header Proxy-Require */
typedef struct sipSupported_t SipPxyRequire;

/* Header Require */
typedef struct sipSupported_t SipRequire;

/* Header Unsupported*/
typedef struct sipSupported_t SipUnsupported;
...
/* Header From */
typedef struct sipTo_t SipFrom;

/* Header Referred-By */
typedef struct sipTo_t SipReferredBy;

/* Header Refer-To */
typedef	struct sipTo_t SipReferTo;

/* Header Reply-To */
typedef struct sipTo_t SipReplyTo;
...
/* Header Server */
typedef struct sipUserAgent_t SipServer;
