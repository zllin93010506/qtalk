 ...
 * sip_int.h
 *
 * $Id: sip_int.h,v 1.7 2009/02/06 07:45:11 tyhuang Exp $
 */
...
SipAcceptEncoding*	AcceptEncodingDup(SipAcceptEncoding*);
...
SipAcceptLang*	AcceptLanguageDup(SipAcceptLang*);
...
int	CallIDAsStr(unsigned char *,unsigned char *, int, int *,BOOL beshortform);
...
CCLAPI int		sipContactAsStr(SipContact *, unsigned char *, int, int *,BOOL beshortform);
...
int	ContentEncodingAsStr(SipContEncoding*, unsigned char*, int, int*,BOOL beshortform);
...
SipContEncoding*	ContentEncodingDup(SipContEncoding*);

/* Content-Length */
int	ContentLengthParse(MsgHdr, void **);
int	ContentLengthAsStr(int, unsigned char*, int, int*,BOOL beshortform);
/*ContentLength's type is int, free is needless */

/* Content-Type */
int	ContentTypeParse(MsgHdr, void **);
int	ContentTypeAsStr(SipContType*, unsigned char*, int, int*,BOOL beshortform);
int	ContentTypeFree(SipContType*);
int	ContentTypeReqDup(SipReq,SipContType*);
int	ContentTypeRspDup(SipRsp,SipContType*);
SipContType*	ContentTypeDup(SipContType*);
...
SipEncrypt*	EncryptionDup(SipEncrypt*);

/* Event  */
int	EventParse(MsgHdr,void**);
int	EventAsStr(SipEvent*, unsigned char*, int, int*,BOOL beshortform);
int	EventFree(SipEvent*);
int	EventReqDup(SipReq, SipEvent*);
int	EventRspDup(SipRsp,SipEvent*);
SipEvent*	EventDup(SipEvent*);
...
SipExpires*	ExpiresDup(SipExpires*);

/* From */
int	FromParse(MsgHdr, void **);
int	FromAsStr(SipFrom*, unsigned char *, int, int *,BOOL beshortform);
int	FromFree(SipFrom*);
int	FromReqDup(SipReq,SipFrom*);
int	FromRspDup(SipRsp,SipFrom*);
SipFrom*	FromDup(SipFrom*);
...
SipPrivacy * PrivacyDup(SipPrivacy *);
...
int	ReferToAsStr(SipReferTo*, unsigned char*, int, int*,BOOL beshortform);
...
int	ReferredByAsStr(SipReferredBy*, unsigned char*, int, int*,BOOL beshortform);
...
SipRequire*	RequireDup(SipRequire*);
...
int	SessionExpiresAsStr(SipSessionExpires*,unsigned char*,int,int*,BOOL beshortform);
...
SipSessionExpires*	SessionExpiresDup(SipSessionExpires*);

/* Server move to ServerHdr */
int	ServerHdrParse(MsgHdr, void **);
int	ServerHdrAsStr(SipServer*, unsigned char *, int, int *);
int	ServerHdrFree(SipServer*);
int	ServerHdrRspDup(SipRsp,SipServer*);
SipServer*	ServerHdrDup(SipServer*);
...
int	ToAsStr(SipTo*, unsigned char *, int, int *,BOOL beshortform);
int	ToFree(SipTo*);
...
SipUnsupported*	UnsupportedDup(SipUnsupported *);
...
SipUserAgent*	UserAgentDup(SipUserAgent*);

/* Via */
int	ProcessViaParm(SipViaParm* , unsigned char*);
int	ViaParse(MsgHdr, void **);
int	ViaAsStr(SipVia*, unsigned char *, int, int *,BOOL beshortform);
int	ViaFree(SipVia*);
...
/* Join */
int JoinParse(MsgHdr, void **);
int	JoinAsStr(SipJoin*, unsigned char *, int, int *);
int	JoinFree(SipJoin*);
int	JoinReqDup(SipReq,SipJoin*);
...
/* Refer-Sub */
int	ReferSubParse(MsgHdr, void **);
int	ReferSubAsStr(SipReferSub*, unsigned char *, int, int *);
int	ReferSubFree(SipReferSub*);
int	ReferSubReqDup(SipReq,SipReferSub*);
int	ReferSubRspDup(SipRsp,SipReferSub*);
SipReferSub* ReferSubDup(SipReferSub*);
...
/* Accept-Contact */
int	AcceptContactParse(MsgHdr, void **);
int	AcceptContactAsStr(unsigned char*, unsigned char *, int, int *);
int	AcceptContactReqDup(SipReq,const unsigned char*);

/* History-Info */
int	HistoryInfoParse(MsgHdr, void **);
int	HistoryInfoAsStr(unsigned char*, unsigned char *, int, int *);
int	HistoryInfoReqDup(SipReq,const unsigned char*);
int	HistoryInfoRspDup(SipRsp,const unsigned char*);

/* P-Access-Network-Info */
int	PANIParse(MsgHdr, void **);
int	PANIAsStr(unsigned char*, unsigned char *, int, int *);
int	PANIReqDup(SipReq,const unsigned char*);
int	PANIRspDup(SipRsp,const unsigned char*);

/* P-Asserted-Service */
int	PASParse(MsgHdr, void **);
int	PASAsStr(unsigned char*, unsigned char *, int, int *);
int	PASReqDup(SipReq,const unsigned char*);

/* P-Preferred-Service */
int	PPSParse(MsgHdr, void **);
int	PPSAsStr(unsigned char*, unsigned char *, int, int *);
int	PPSReqDup(SipReq,const unsigned char*);

/* P-Debug-ID */
int	PDIDParse(MsgHdr, void **);
int	PDIDAsStr(unsigned char*, unsigned char *, int, int *);
int	PDIDReqDup(SipReq,const unsigned char*);

/* P-Profile-Key */
int	PPKParse(MsgHdr, void **);
int	PPKAsStr(unsigned char*, unsigned char *, int, int *);
int	PPKReqDup(SipReq,const unsigned char*);

/* P-Served-User */
int	PSUParse(MsgHdr, void **);
int	PSUAsStr(unsigned char*, unsigned char *, int, int *);
int	PSUReqDup(SipReq,const unsigned char*);

/* P-Private-Network-Indication */
int	PPNIParse(MsgHdr, void **);
int	PPNIAsStr(unsigned char*, unsigned char *, int, int *);
int	PPNIReqDup(SipReq,const unsigned char*);

/* P-Early-Media */
int	PEMParse(MsgHdr, void **);
int	PEMAsStr(unsigned char*, unsigned char *, int, int *);
int	PEMReqDup(SipReq,const unsigned char*);
int	PEMRspDup(SipRsp,const unsigned char*);

/* Reason */
int	ReasonParse(MsgHdr, void **);
int	ReasonAsStr(unsigned char*, unsigned char *, int, int *);
int	ReasonReqDup(SipReq,const unsigned char*);
int	ReasonRspDup(SipRsp,const unsigned char*);

/* Resource-Priority */
int	RPParse(MsgHdr, void **);
int	RPAsStr(unsigned char*, unsigned char *, int, int *);
int	RPReqDup(SipReq,const unsigned char*);

/* Session-ID */
int	SessionIDParse(MsgHdr, void **);
int	SessionIDAsStr(unsigned char*, unsigned char *, int, int *);
int	SessionIDReqDup(SipReq,const unsigned char*);
int	SessionIDRspDup(SipRsp,const unsigned char*);
...
SipParam*	sipParameterDupAll(SipParam*);
