 ...
 * sipTx.h
 *
 * $Id: sipTx.h,v 1.2 2008/11/14 07:36:47 tyhuang Exp $
 */
#ifndef __SIP_TX__
#define __SIP_TX__
...
CCLAPI unsigned short sipTxGetInternalNum(TxStruct);
...
CCLAPI RCODE CommonTimerDel(IN INT32 timerid, OUT void** data);
