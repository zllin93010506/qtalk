...
public class AlcTransform implements IAudioTransform 
{
    //public  final static String CODEC_NAME = "G7221";
    //public  final static int    DEFAULT_ID = 102;
    private final static String TAG = "AlcTransform";
    private static final String DEBUGTAG = "QTFa_AlcTransform";
    ...
    static
    {
        System.loadLibrary("media_alc_transform");
    }
