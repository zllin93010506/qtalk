...
#include <stdlib.h>
#include <jni.h>
#include <android/log.h> //#include "logging.h"
//#include <logger.h>

#define LOG_TAG "welsdec"
#define LOGI(...) __android_log_print(ANDROID_LOG_DEBUG, LOG_TAG, __VA_ARGS__)  //__logback_print(ANDROID_LOG_DEBUG, LOG_TAG, __VA_ARGS__)
