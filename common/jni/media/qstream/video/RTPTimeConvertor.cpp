...
//    if (mFirstRemoteTime.tv_sec==0 && mFirstRemoteTime.tv_usec==0 && mFirstRtpTimeStamp!=0)
//    {
//        RtpTime2NTPClock(mFirstRtpTimeStamp,&mFirstRemoteTime.tv_sec,&mFirstRemoteTime.tv_usec);
//    }
}
...
//
//uint32_t CRTPTimeConvertor::RemoteTimeToLocalTime(uint32_t rtp_timestamp,
//                                                    long *p_clock_sec,
//                                                    long *p_clock_usec)
//{
//    uint32_t rtp_timestamp_offset;
//    struct timeval clock_time_offset;
//    struct timeval clock_time_result;
//    if (mFirstRtpTimeStamp!=0)
//    {
//        if ( ( (rtp_timestamp - mFirstRtpTimeStamp) & 0x80000000 )!= 0) {/*rtp_timestamp < mSrTimestamp*/
//            rtp_timestamp_offset = mFirstRtpTimeStamp - rtp_timestamp;
//            convert_rtp_timestamp_offset_into_clock_time_offset(mSampleRate,rtp_timestamp_offset, &clock_time_offset);
//            clock_time_minus(&mFirstLocalTime, &clock_time_offset, &clock_time_result);
//        }
//        else {  /*rtp_timestamp >= mSrTimestamp*/
//            rtp_timestamp_offset = rtp_timestamp - mFirstRtpTimeStamp;
//            convert_rtp_timestamp_offset_into_clock_time_offset(mSampleRate,rtp_timestamp_offset, &clock_time_offset);
//            clock_time_add(&mFirstLocalTime, &clock_time_offset, &clock_time_result);
//        }
//    }else
//    {
//        clock_time_result.tv_sec = 0;
...
//}
//
//void CRTPTimeConvertor::SetFirstTimeStamp(uint32_t rtp_timestamp)
//{
//    mFirstRtpTimeStamp = rtp_timestamp;
//    mFirstRemoteTime.tv_sec = 0;
//    mFirstRemoteTime.tv_usec = 0;
//    gettimeofday(&mFirstLocalTime, NULL);
//}
