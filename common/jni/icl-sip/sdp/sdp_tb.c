 ...
 * sdp_tb.c
 *
 * $Id: sdp_tb.c,v 1.3 2008/09/15 08:37:06 tyhuang Exp $
 */
...
static char BANDWIDTH_MODIFIER_TOKEN[SDP_TB_MAX_TOKEN_SIZE][5] = {
	"NONE",
	"CT",
	"AS",
	"X-",
...
{
	if(m<SDP_TB_MAX_TOKEN_SIZE)
		return BANDWIDTH_MODIFIER_TOKEN[m];
	else
		return NULL;
}
