 ...
 * sdp_ta.h
 *
 * $Id: sdp_ta.h,v 1.2 2008/12/05 09:08:59 tyhuang Exp $
 */
...
#define SDP_MAX_TA_VALUE_SIZE		512 /* 128 */
#define SDP_MAX_TA_SIZE				544 /*SDP_MAX_TA_ATTRIB_SIZE + SDP_MAX_TA_VALUE_SIZE*/
