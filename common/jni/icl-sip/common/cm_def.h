 ...
 * cm_def.h
 *
 * $Id: cm_def.h,v 1.1.1.1 2008/08/01 07:00:24 judy Exp $
 */
...
/**
 * @brief LogFlag -- Define the ways to record trace log
 */
/**************** Trace Log Flags *************/
typedef enum {
...
/**
 * @brief TraceLevel -- Define the tracing level
 */
/**************** Trace Level *****************/
typedef enum {
...
/**
 * @brief macro (__CMFILE__)
 *
 * Use this macro to replace __FILE__ macro if you don't want the path included
 */
