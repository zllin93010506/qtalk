...
/* Analyse flags
 */
#if PL330_COMPATIBLE                                       /// ENFORCE INTEROPERABILITY WITH PL330 ///
#define X264_ANALYSE_I4x4       0x0000  /* Analyse i4x4 */ /// ENFORCE INTEROPERABILITY WITH PL330 ///
#else                                                      /// ENFORCE INTEROPERABILITY WITH PL330 ///
#define X264_ANALYSE_I4x4       0x0001  /* Analyse i4x4 */
#endif                                                     /// ENFORCE INTEROPERABILITY WITH PL330 ///
...
int  GetLastIDR(x264_t *h);
int64_t  GetFrameNumber(x264_t *h);
int  GetAllInputNumber(x264_t *h);
void  SetLastIDR(x264_t *h,int value);
void  SetFrameNumber(x264_t *h,int64_t value);
void  SetAllInputNumber(x264_t *h,int value);
#endif
