 ...
 * sip_req.h
 *
 * $Id: sip_req.h,v 1.3 2008/11/14 09:39:26 tyhuang Exp $
 */
...
CCLAPI RCODE		sipReqRemoveBody(IN SipReq);
...
CCLAPI RCODE		sipReqSetUseShortForm(IN SipReq,IN BOOL useshortform);
/***********************************************************************
