 ...
 * dx_lst.c
 *
 * $Id: dx_lst.c,v 1.1.1.1 2008/08/01 07:00:24 judy Exp $
 */
/** 
* @file dx_lst.c
* @brief Define dx link list related functions
...
void*   dxLstGetHead(DxLst _this)
{
	...
	/* update this->Iter_ */
	if(_this->Iter_==_this->head_)
		_this->Iter_=_this->head_->next_;
