...
public class MjpegEncodeTransform implements IVideoTransform, IVideoStreamSourceCB
{
    public  final static String CODEC_NAME = "MJPEG";
    private final static String TAG = "MjpegEncodeTransform";
    private static final String DEBUGTAG = "QTFa_MjpegEncodeTransform";
    ...
    protected MjpegEncodeTransform(){}
    @Override
    ...
    private static native int  _Start(final ISink sink,final int pixformat,final int width,final int height);
